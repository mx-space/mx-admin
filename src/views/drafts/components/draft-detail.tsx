          ...
          <div class="flex items-center gap-2">
            <span class="text-sm font-medium text-neutral-900 dark:text-neutral-100">
              ...
              {props.item.isCurrent && (
                <span class="mx-1 rounded bg-neutral-200 px-1.5 py-0.5 text-xs text-neutral-600 dark:bg-neutral-700 dark:text-neutral-300">
                  当前
                </span>
              )}{' '}
  ...
  setup(props) {
    ...
    return () => (
      <div class="flex h-full flex-col">
        {/* 头部信息 */}
        <div class="flex flex-shrink-0 items-center justify-between border-b border-neutral-200 bg-white px-4 py-3 dark:border-neutral-800 dark:bg-neutral-900">
