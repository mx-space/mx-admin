            ...
            <form onSubmit={handleLogin} class="w-full max-w-[280px]">
              ...
              <div class="relative mb-4">
                ...
                <input
                  ...
                  class="h-[38px] w-full rounded-full border-0 bg-white/20 px-4 text-center text-[15px] text-white backdrop-blur-md transition-all placeholder:text-white/60 focus-visible:bg-white/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 disabled:cursor-not-allowed disabled:opacity-50"
                />
