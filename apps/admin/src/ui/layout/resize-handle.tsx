...
export function ResizeHandle({ className, disabled, ...rest }: SeparatorProps) {
  return (
    <Separator
      {...rest}
      className={cn(
        'outline-hidden relative w-0 shrink-0 cursor-col-resize',
        ...
        'hover:border-neutral-400 hover:after:opacity-100 dark:hover:border-neutral-600',
        'focus-visible:border-neutral-400 focus-visible:after:opacity-100 dark:focus-visible:border-neutral-600',
        'data-[separator=active]:border-neutral-400 data-[separator=active]:after:opacity-100 dark:data-[separator=active]:border-neutral-600',
        disabled &&
          'pointer-events-none border-transparent hover:after:opacity-0',
        className,
      )}
      disabled={disabled}
    />
