...
const contentListActionClassName =
  'inline-flex h-8 shrink-0 items-center justify-center gap-1.5 rounded border text-xs font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-[var(--color-primary-shallow)] disabled:pointer-events-none disabled:opacity-50'
const contentListIconActionClassName = 'size-7 border-transparent'
const contentListTextActionPaddingClassName = 'px-2.5'
  ...
  return (
    <button
      className={cn(
        ...
        iconOnly
          ? contentListIconActionClassName
          : contentListTextActionPaddingClassName,
        danger
          ? cn(
