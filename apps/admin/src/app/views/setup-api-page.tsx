...
function SetupActionButton({
  ...
  return (
    <button
      ...
      className={
        tone === 'primary'
          ? 'flex h-10 items-center justify-center gap-2 rounded-full bg-white/90 text-sm font-medium text-neutral-950 transition-colors hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50'
          : 'flex h-10 items-center justify-center gap-2 rounded-full bg-white/15 text-sm text-white/90 transition-colors hover:bg-white/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50'
      }
      onClick={onClick}
      type={type}
    >
