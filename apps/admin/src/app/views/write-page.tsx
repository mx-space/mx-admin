...
import type { Amap, AMapSearch } from '~/app/models/amap'
import type { Image as ImageModel } from '~/app/models/base'
...
import { getDayOfYear } from '~/app/utils/time'
          ...
          {props.kind === 'page' ? (
            ...
            <div className="flex shrink-0 items-center gap-1.5">
              ...
              <WriteHeaderIconButton
                ...
                title={props.kind === 'post' ? '文章设置' : '手记设置'}
                type="button"
              >
                <SlidersHorizontal aria-hidden="true" className="size-4" />
              </WriteHeaderIconButton>
        ...
        {detailQuery.isLoading ? (
                ...
                <div className="min-w-0">
                  <div className="mx-auto w-full max-w-[60rem] shrink-0 px-3 pb-2 pt-6">
                    <div className="flex min-w-0 items-center gap-2">
                      <TextInput
                        autoFocus={!isEditing}
                        controlClassName="h-auto min-w-0 flex-1 !rounded-none !border-transparent !bg-transparent px-0 py-3 text-2xl font-semibold !shadow-none !outline-none focus:!border-transparent focus:!ring-0 focus-visible:!outline-none dark:!border-transparent dark:!bg-transparent"
                    ...
                    <div className="mt-2 grid gap-2">
                      <div className="flex min-w-0 items-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
                        ...
                        <input
                          className="min-w-20 max-w-full border-b border-transparent bg-transparent px-0.5 text-neutral-600 outline-none transition-colors placeholder:text-neutral-400 hover:border-neutral-200 focus:border-neutral-400 dark:text-neutral-400 dark:placeholder:text-neutral-600 dark:hover:border-neutral-700 dark:focus:border-neutral-500"
                          onChange={(event) =>
                      ...
                      <input
                        className="h-7 w-full bg-transparent px-0.5 text-sm text-neutral-600 outline-none placeholder:text-neutral-400 dark:text-neutral-400 dark:placeholder:text-neutral-500"
                        onChange={(event) =>
          ...
          >
            <main className="flex min-h-full min-w-0 flex-col bg-white dark:bg-neutral-950">
              <div
                className="mx-auto w-full shrink-0 px-3 pb-2 pt-6"
                style={{ maxWidth: agentVisible ? '82rem' : '60rem' }}
              >
                <div className="flex min-w-0 items-center gap-2">
                  <TextInput
                ...
                <div className="mt-2 min-w-0 px-0.5">
                  {props.kind === 'post' ? (
                    <div className="flex min-w-0 items-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
                      <span className="select-none truncate text-neutral-400 dark:text-neutral-500">
                        {`${WEB_URL}/posts/${activeCategory?.slug ?? ''}/`}
                      </span>
                      <input
                        className="min-w-20 max-w-full border-b border-transparent bg-transparent px-0.5 text-neutral-600 outline-none transition-colors placeholder:text-neutral-400 hover:border-neutral-200 focus:border-neutral-400 dark:text-neutral-400 dark:placeholder:text-neutral-600 dark:hover:border-neutral-700 dark:focus:border-neutral-500"
                        onChange={(event) =>
                      ...
                      state.text.trim().length > 0 ? (
                        <button
                          ...
                          className="inline-flex size-6 shrink-0 items-center justify-center rounded text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-600 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-500 dark:hover:bg-neutral-800 dark:hover:text-neutral-300"
...
function ContentSettingsDrawer(props: {
  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Popup className="fixed bottom-0 right-0 top-0 z-50 flex w-[min(90vw,28.125rem)] flex-col border-l border-neutral-200 bg-white shadow-xl outline-none dark:border-neutral-800 dark:bg-neutral-950">
  ...
  return (
    ...
    >
      <Dialog.Portal>
        <Dialog.Backdrop className="fixed inset-0 z-40 bg-black/35" />
        <Dialog.Popup
          className="fixed left-1/2 top-1/2 z-50 flex max-h-[88vh] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded border border-neutral-200 bg-white shadow-xl outline-none dark:border-neutral-800 dark:bg-neutral-950"
          style={{ height: 'min(82vh, 38rem)', width: 'min(92vw, 56rem)' }}
        >
          <div className="flex h-14 shrink-0 items-center justify-between border-b border-neutral-200 px-4 dark:border-neutral-800">
            <Dialog.Title className="inline-flex min-w-0 items-center gap-2 text-sm font-medium text-neutral-950 dark:text-neutral-50">
              <History aria-hidden="true" className="size-4 shrink-0" />
              <span className="truncate">发现未完成的草稿</span>
            </Dialog.Title>
            <Dialog.Close
              aria-label="关闭"
              className="inline-flex size-9 items-center justify-center rounded text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-600 dark:hover:bg-neutral-900 dark:hover:text-neutral-200"
  ...
  return (
    ...
    >
      <Dialog.Portal>
        <Dialog.Backdrop className="fixed inset-0 z-40 bg-black/35" />
        <Dialog.Popup
          className="fixed left-1/2 top-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded border border-neutral-200 bg-white shadow-xl outline-none dark:border-neutral-800 dark:bg-neutral-950"
          style={{
        ...
        >
          <div className="flex shrink-0 items-center justify-between border-b border-neutral-200 px-4 py-3 dark:border-neutral-800">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                当前草稿更新于 {formatDateTime(props.draft.updatedAt)}
                ，可与已发布内容对比后恢复。
              </p>
            </div>
            <Dialog.Close
...
function WriteHeaderIconButton(props: {
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex size-9 items-center justify-center rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-40 dark:focus-visible:ring-neutral-500 dark:focus-visible:ring-offset-neutral-900',
...
function PageFormatToggle(props: {
  format: ContentFormat
  onToggle: () => void
}) {
  const isRichMode = props.format === 'lexical'
  const title = isRichMode ? '切换到 Markdown 编辑器' : '切换到 Rich 编辑器'

  return (
    <button
      aria-label={title}
      className="inline-flex size-8 shrink-0 items-center justify-center rounded-md border border-neutral-300 text-neutral-600 transition-colors hover:border-neutral-400 hover:text-neutral-800 dark:border-neutral-600 dark:text-neutral-400 dark:hover:border-neutral-500 dark:hover:text-neutral-200"
...
function LocationSearchDialog(props: {
  ...
  return (
    ...
    >
      <Dialog.Portal>
        <Dialog.Backdrop className="fixed inset-0 z-40 bg-black/35" />
        <Dialog.Popup className="fixed left-1/2 top-1/2 z-50 flex w-[min(92vw,30rem)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded border border-neutral-200 bg-white shadow-xl outline-none dark:border-neutral-800 dark:bg-neutral-950">
          <div className="flex h-14 shrink-0 items-center justify-between border-b border-neutral-200 px-4 dark:border-neutral-800">
            <Dialog.Title className="inline-flex min-w-0 items-center gap-2 text-sm font-medium text-neutral-950 dark:text-neutral-50">
              <Search aria-hidden="true" className="size-4 shrink-0" />
              <span className="truncate">搜索关键字查找地点</span>
            </Dialog.Title>
            <Dialog.Close
              aria-label="关闭"
              className="inline-flex size-9 items-center justify-center rounded text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-600 dark:hover:bg-neutral-900 dark:hover:text-neutral-200"
  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Popup
          className="fixed left-1/2 top-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded border border-neutral-200 bg-white shadow-xl outline-none dark:border-neutral-800 dark:bg-neutral-950"
          style={{ height: 'min(82vh, 42rem)', width: 'min(92vw, 56rem)' }}
        >
          <div className="flex h-14 shrink-0 items-center justify-between border-b border-neutral-200 px-4 dark:border-neutral-800">
            <Dialog.Title className="text-sm font-medium text-neutral-950 dark:text-neutral-50">
              解析 Markdown
...
function PageLexicalDebugDialog(props: {
  ...
  return (
    ...
    >
      <Dialog.Portal>
        <Dialog.Backdrop className="fixed inset-0 z-40 bg-black/35" />
        <Dialog.Popup className="fixed bottom-0 right-0 top-0 z-50 flex w-[min(92vw,38rem)] flex-col border-l border-neutral-200 bg-white shadow-xl outline-none dark:border-neutral-800 dark:bg-neutral-950">
          <div className="flex h-14 shrink-0 items-center justify-between border-b border-neutral-200 px-4 dark:border-neutral-800">
            <Dialog.Title className="inline-flex min-w-0 items-center gap-2 text-sm font-medium text-neutral-950 dark:text-neutral-50">
              <Bug aria-hidden="true" className="size-4 shrink-0" />
              <span className="truncate">Lexical State</span>
            </Dialog.Title>
            <Dialog.Close
              aria-label="关闭"
              className="inline-flex size-9 items-center justify-center rounded text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-600 dark:hover:bg-neutral-900 dark:hover:text-neutral-200"
...
function RichWriteSurface(props: {
  ...
  return (
    <div
      className={cn(
        'grid min-h-0 gap-3',
        props.agentVisible && 'xl:grid-cols-[minmax(0,1fr)_20rem]',
      )}
    >
      <Suspense
...
function WriteAgentPanel(props: {
  ...
  return (
    <aside className="flex min-h-96 flex-col border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-950">
      <div className="flex shrink-0 items-center justify-between border-b border-neutral-200 px-3 py-2 dark:border-neutral-800">
        <div className="inline-flex min-w-0 items-center gap-2 text-sm font-medium text-neutral-950 dark:text-neutral-50">
          <Bot aria-hidden="true" className="size-4 shrink-0" />
          <span className="truncate">AI 助手</span>
        </div>
        <button
          className="inline-flex size-7 items-center justify-center rounded text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-700 dark:hover:bg-neutral-900 dark:hover:text-neutral-200"
      ...
      <div className="grid gap-2 border-b border-neutral-200 p-2 dark:border-neutral-800">
        ...
        <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-1.5">
          {editingSession ? (
            <input
              autoFocus
              className="h-8 min-w-0 border border-neutral-200 bg-white px-2 text-xs text-neutral-700 outline-none focus:border-neutral-400 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-200"
              onBlur={finishRename}
        ...
        <select
          className="h-8 w-full border border-neutral-200 bg-white px-2 text-xs text-neutral-700 outline-none focus:border-neutral-400 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-200"
      ...
      >
        <textarea
          className="min-h-20 resize-y border border-neutral-200 bg-white px-2 py-1.5 text-sm leading-5 text-neutral-900 outline-none placeholder:text-neutral-400 focus:border-neutral-400 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-100"
