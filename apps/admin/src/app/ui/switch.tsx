  ...
  return (
    ...
    >
      ...
      <BaseSwitch.Root
        ...
        className="relative inline-flex h-5 min-w-9 items-center rounded-full bg-neutral-200 px-0.5 outline-none transition-colors data-[disabled]:cursor-not-allowed data-[checked]:bg-neutral-950 data-[disabled]:opacity-50 data-[focus-visible]:ring-2 data-[focus-visible]:ring-[var(--color-primary-shallow)] dark:bg-neutral-800 dark:data-[checked]:bg-neutral-50"
        disabled={props.disabled}
        onCheckedChange={props.onCheckedChange}
      >
        <BaseSwitch.Thumb className="block size-4 translate-x-0 rounded-full bg-white shadow-sm transition-transform data-[checked]:translate-x-4 dark:data-[checked]:bg-neutral-950" />
      </BaseSwitch.Root>
    </label>
  )
}
